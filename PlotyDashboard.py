...
def get_scatter_plot(entered_site, payload_value):
    print('PVALUE', payload_value)

    filtered_df = spacex_df[spacex_df['Payload Mass (kg)'] > payload_value[0]]
    filtered_df = filtered_df[filtered_df['Payload Mass (kg)'] < payload_value[1]]


    if entered_site != 'ALL':
        filtered_df = spacex_df[spacex_df['Launch Site'] == entered_site]
    #print(filtered_df['class'])
    #print(filtered_df['Payload Mass (kg)'])
